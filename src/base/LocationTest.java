...
public class LocationTest {
	...
	public void testDrawGridLines() {
		...
		// Mock the Graphics object (this is simplified for demonstration)
		MockGraphics mockGraphics = new MockGraphics();
		location.drawGridLines(mockGraphics);

		// Verify that the expected number of lines are drawn
		assertEquals(8, mockGraphics.getNumberOfHorizontalLines());
		assertEquals(9, mockGraphics.getNumberOfVerticalLines());
	}
	...
	// Helper class for mocking the Graphics object
	private static class MockGraphics extends java.awt.Graphics {
		...
		// Other methods of the Graphics class are not implemented for this example
	}
}